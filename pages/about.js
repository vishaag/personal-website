  ...
  return (
    <Layout about>
      ...
      <section className={utilStyles.marginTop3rem}>
        ...
        <p>I have strong experience building web applications with HTML, CSS, Javascript and React among other technologies. I strive to write accessible, performant and tested code and have a good eye for detail. I love to experiment and always keep upto date with new advancements in the field.</p>
        <p>I've previsouly worked at <a href="https://www.oracle.com/industries/construction-engineering/products/" target="_blank">Oracle</a>, <a href="https://www.beautifulcode.co/" target="_blank">Beautiful Code</a> and <a href="https://www.srx.com.sg/" target="_blank">Streetsine SRX</a> and I'm actively looking for my next role. If you're hiring a front-end / full-stack engineer, please get in touch with me!</p>
