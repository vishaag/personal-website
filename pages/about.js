  ...
  return (
    <Layout about>
      ...
      <section className={utilStyles.marginTop3rem}>
        ...
        <p>I've previously worked at <a href="https://www.oracle.com/industries/construction-engineering/products/" target="_blank" rel="noopener">Oracle</a>, <a href="https://www.beautifulcode.co/" target="_blank" rel="noopener">Beautiful Code</a> & <a href="https://www.srx.com.sg/" target="_blank" rel="noopener">Streetsine SRX</a> and I'm actively looking for my next role. If you're in the market to hire a front-end / full-stack engineer, please get in touch with me!</p>
